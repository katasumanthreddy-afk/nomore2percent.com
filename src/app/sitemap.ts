...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/blog/rera-telangana-guide-hyderabad-home-buyers`, changeFrequency: 'monthly', priority: 0.5 },
    { url: `${BASE_URL}/blog/evaluate-resale-apartment-hyderabad-checklist`, changeFrequency: 'monthly', priority: 0.5 },
    { url: `${BASE_URL}/blog/gachibowli-vs-kondapur-vs-kokapet-comparison`, changeFrequency: 'monthly', priority: 0.5 },
