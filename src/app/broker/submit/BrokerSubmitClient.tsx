      ...
      <div className="flex-1 bg-stone-50">
        ...
        <div className="max-w-lg mx-auto px-6 py-24 text-center">
          ...
          <p className="text-stone-500 text-sm mb-6">
            Thanks! We'll verify the details and photos. Once approved, it'll go live on nomore2percent — usually within 24 hours.
          </p>
          <Link href="/broker" className="text-orange-500 text-sm font-semibold hover:underline">← Back to Your Listings</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="flex-1 bg-stone-50">
      ...
      <div className="max-w-2xl mx-auto px-6 md:px-10 py-12">
        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-6 md:p-8 space-y-6">
          ...
          {/* Location */}
          <div>
            <div className="text-sm font-bold text-stone-800 mb-3">Pin the Property's Location <span className="font-normal text-stone-400">(optional, but helps buyers find it)</span></div>
            <LocationPicker
              lat={form.lat}
              lng={form.lng}
